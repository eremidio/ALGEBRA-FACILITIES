...
/*
OBS.: NO CÁLCULO DO DETERMINANTES DE MATRIZES USAR AS OPERAÇÕES DE TRANSPOSIÇÃO DE LINHAS E COLUNAS PARA COLOCAR O ELEMENTO COM MAIOR NÚMEROS DE ZEROS NA PRIMEIRA LINHA 
...
T result=0;
//Procedimentos
//Loop principal: produtos dos elementos da primeira linha pelos respectivos cofatores
for(i=0; i<m1.rows; ++i){
