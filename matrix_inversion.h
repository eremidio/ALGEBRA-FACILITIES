...
/*
OBS: USAREMOS UM ALGORITMO QUE UTILIZA COFATORES DA MATRIZ ORIGINBAL PARA CALCULAR MATRIZES INVERSAS E DETERMINANTES DE MATRIZES. NÃO É O ALGORITMO MAIS EFICIENTE, PORÉM 
É RELATIVAMENTE SIMPLES DE SE IMPLEMENTAR. POSSUI GRANDE INTERESSE TEÓRICO NO QUE CONCERNE A ÁLGEBRA DE MATRIZES.
...
if(((i+j)%2)==0)
inverse_matrix.matrix[i][j]=determinant(cofactor_matrix)/matrix_determinant;
if(((i+j)%2)==1)
inverse_matrix.matrix[i][j]=((-1)*determinant(cofactor_matrix))/matrix_determinant;
