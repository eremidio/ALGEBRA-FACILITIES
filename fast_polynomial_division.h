//VAMOS CRIAR UM PROGRAMA QUER IMPLEMENTA ROTINAS EFICIENTES PARA DIVISÃO DE POLINÔMIOS 
...
template<typename T>
void fast_polynomial_division(polynomial<T>&, polynomial<T>&, polynomial<T>&, polynomial<T>&);
...
template<typename T>
void fast_polynomial_division(polynomial<T>& A, polynomial<T>& B, polynomial<T>& quotient, polynomial<T>& remainder){
